...
export function getTargetBitrate(
  ...
  const maxFpsDifference =
    fpsTranscodingConstants.MAX - fpsTranscodingConstants.AVERAGE;
  ...
  return (
    baseBitrate +
    (fps - fpsTranscodingConstants.AVERAGE) *
      (maxBitrateDifference / maxFpsDifference)
  );
}
