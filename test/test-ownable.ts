...
describe('Ownable', function () {
  ...
  it('should check the accounts', async function () {
    chai
      .expect(deployerAddress)
      .to.equal('0x33ec9a535dc0f5168851fd064f40da71144ca168');

    chai.expect(owner.address.toLowerCase()).to.equal(deployerAddress);
  });
  ...
  it('should return a contract factory', async function () {
    ...
    const contract = await hardhat.ethers.getContractFactory('Ownable');
  ...
  describe('Ownable contract', function () {
    it('should return a contract instance', async function () {
      const contract = await deployEthers.getContract('Ownable');
  ...
  describe('TestOwnable contract', function () {
    it('should return a contract instance', async function () {
      const contract = await deployEthers.getContract('TestOwnable');
    ...
    it('should return a contract instance associated with a custom signer', async function () {
      const contract = await deployEthers.getContract('TestOwnable', nonOwner);
